                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input type="number" name="harga_beli" id="harga_beli" value="{{ old('harga_beli', $product->harga_beli) }}" 
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input type="number" name="harga_jual" id="harga_jual" value="{{ old('harga_jual', $product->harga_jual) }}" 
                                        class="pl-12 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                @error('harga_jual')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="mt-1 flex items-center">
                                    @if($product->gambar_produk)
                                        <div class="mr-4">
                                            <img src="{{ asset('storage/products/' . $product->gambar_produk) }}" 
        ...
        document.getElementById('gambar_produk').addEventListener('change', function(e) {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    ...
                    preview.className = 'h-32 w-32 object-cover rounded-lg';
