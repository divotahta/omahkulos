                ...
                <form action="{{ route('admin.suppliers.update', $supplier) }}" method="POST"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                <label for="nama" class="block text-sm font-medium text-gray-700">Nama Pemasok <span
                            ...
                            <div>
                                <label for="nama_toko" class="block text-sm font-medium text-gray-700">Nama Toko <span
                                        class="text-red-500">*</span></label>
                                <input type="text" name="nama_toko" id="nama_toko"
                                    value="{{ old('nama_toko', $supplier->nama_toko) }}" required
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                @error('nama_toko')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                <label for="telepon" class="block text-sm font-medium text-gray-700">Telepon <span
                                        class="text-red-500">*</span></label>
                            ...
                            <div>
                                ...
                                <textarea name="alamat" id="alamat" rows="3" required
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('alamat', $supplier->alamat) }}</textarea>
                                @error('alamat')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                <label for="jenis" class="block text-sm font-medium text-gray-700">Jenis <span
                                        class="text-red-500">*</span></label>
                                <select name="jenis" id="jenis" required
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    <option value="">Pilih Jenis</option>
                                    <option value="distributor"
                                        {{ old('jenis', $supplier->jenis) == 'distributor' ? 'selected' : '' }}>
                                        Distributor</option>
                                    <option value="grosir"
                                        {{ old('jenis', $supplier->jenis) == 'grosir' ? 'selected' : '' }}>Grosir
                                    </option>
                                </select>
                                @error('jenis')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="pemegang_rekening" id="pemegang_rekening"
                                    value="{{ old('pemegang_rekening', $supplier->pemegang_rekening) }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <div>
                                ...
                                @error('foto')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                                <div id="preview" class="mt-2 {{ $supplier->foto ? '' : 'hidden' }}">
                                    <img src="{{ $supplier->foto ? Storage::url($supplier->foto) : '' }}"
                                        alt="Preview" class="h-32 w-32 object-cover rounded-lg">
                                </div>
                            </div>
                        </div>
                    </div>
